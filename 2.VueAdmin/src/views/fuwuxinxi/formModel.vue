				...
				<el-row>
					...
					<el-col :span="12">
						<el-form-item label="服务价格" prop="fuwujiage">
							<el-input class="list_inp" v-model.number="form.fuwujiage" placeholder="服务价格"
								 type="number" 								:readonly="!isAdd||disabledForm.fuwujiage?true:false" />
						</el-form-item>
					</el-col>
					...
					<el-col :span="12">
						<el-form-item label="服务介绍" prop="fuwujieshao">
							<el-input v-model="form.fuwujieshao" placeholder="服务介绍" type="textarea"
							:readonly="!isAdd||disabledForm.fuwujieshao?true:false"
							/>
						</el-form-item>
					</el-col>
				</el-row>
	...
	const init=(formId=null,formType='add',formNames='',row=null,table=null,statusColumnName=null,tips=null,statusColumnValue=null)=>{
		...
		if(formType == 'add'){
			...
			for(let x in row){
				...
				if(x=='fuwujieshao'){
					form.value.fuwujieshao = row[x];
					disabledForm.value.fuwujieshao = true;
					continue;
				}
				if(x=='tupian'){
